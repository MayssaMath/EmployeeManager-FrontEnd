...
export class AppComponent implements OnInit{
  ...
  ngOnInit(){//whenever the component is initialized it's going to call this function
    this.getEmployees();
  }
  ...
  public onOpenModal(employee: Employee, mode: string): void{
    ...
    //si on clique sur edit editEmployee va recevoir tous les attributs de employee et vont être affichés
    //dans les champs du formulaire edit
    if(mode == 'edit'){
